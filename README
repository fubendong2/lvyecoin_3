...
LvyeCoin very-unofficial development tree
---------------------------------------

Maintained by bitcointalk.org user WindMaster

This is not the official LvyeCoin client repository, but rather a fork I
created to continue development and promotion of LvyeCoin after the original
developer, GitHub user pocopoco, stopped actively participating in the
community immediately after launch of the coin.  The official LvyeCoin
repository is located at:

https://github.com/pocopoco/lvyecoin/


LvyeCoin - a hybrid scrypt PoW + PoS based cryptocurrency forked from NovaCoin
by GitHub user pocopoco.


NOTE: All of the information below is as cloned from pocopoco's
repository.  Much of it is known to not be correct for LvyeCoin, and
...
official, stable release versions of LvyeCoin.
